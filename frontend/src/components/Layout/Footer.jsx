...
const Footer = () => {
  return (
    <div className="bg-[#000] text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#2e2b2b] py-7">
        <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
          <span className="text-white">Subscribe</span> us for latest {" "}
          <br />
          events and offers
        </h1>
        <div>
          <input
            ...
            className="text-gray-800
                sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 focus:outline-none border-white rounded-md"
          />
          <button className="bg-white hover:bg-teal-500 duration-300 px-5 py-2.5 text-black md:w-auto w-full rounded-md">
            Submit
          </button>
        </div>
      </div>
